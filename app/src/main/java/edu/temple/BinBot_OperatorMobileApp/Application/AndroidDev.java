package edu.temple.BinBot_OperatorMobileApp.Application;
...
public class AndroidDev {
	 ...
	 * objects and translate it to formats that can be read in java/android system
	 *
	 * @author Kwamina M Thompson
	 * @version 1.0
	 * @since 2019-10-13
	...
	/**
	 * <h1> OnDisplay(Object img) </h1> this method takes in an image object that has been 
	 * was processed by OnJSONreciever method then displays the image on the application's
	 * screen.
	 * @author Kwamina M Thompson
	 * @version 1.0
	 * @param img
