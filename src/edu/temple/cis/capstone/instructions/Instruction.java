...
/**
 * The Instruction class represents a set of edu.temple.cis.capstone.instructions that BinBot should follow in order to retrieve trash. It is
...
//			treads.add(new Pair<>(jo.getDouble("angle"), jo.getDouble("distance")));
     ...
     * waste has been located and if waste is in the image. Based on this data, edu.temple.cis.capstone.instructions will be calculated for
